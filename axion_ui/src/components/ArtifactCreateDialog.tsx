...
import type { ArtifactKind, ArtifactType, ArtifactCreate } from "../types";
...
export default function ArtifactCreateDialog({
  ...
  const [type, setType] = useState<ArtifactType>("langfuse_trace");
    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      ...
      <DialogActions>
        ...
        <Button
          ...
          variant="contained"
          disabled={loading || !label.trim() || !payload.trim()}
        >
          Add
        </Button>
      </DialogActions>
